...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Rn,depthTest:!1,depthWrite:!1})}function fl(){return new _n({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:tr(),fragmentShader:`
		...
		`,blending:Rn,depthTest:!1,depthWrite:!1})}function ul(){return new _n({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:tr(),fragmentShader:`
